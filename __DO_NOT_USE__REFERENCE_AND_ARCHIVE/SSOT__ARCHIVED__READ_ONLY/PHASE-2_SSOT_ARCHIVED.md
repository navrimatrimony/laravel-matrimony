...
Day: Phase-2 Polish – Notification Demo Word Removal

- Removed all user-facing references to "demo" from notifications
- Unified notification copy to "{Name} viewed your profile."
- Internal is_view_back tracking preserved
- SSOT updated to enforce demo as internal-only concept
- Unused demo_profiles image directory removed
