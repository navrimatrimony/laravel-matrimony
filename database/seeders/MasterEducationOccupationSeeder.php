...
class MasterEducationOccupationSeeder extends Seeder
{
    ...
    private function seedMasterEducation(): void
    {
        $rows = [
            ...
            ['name' => 'Bachelor of Arts', 'code' => 'ba', 'group' => 'bachelor', 'sort_order' => 50],
            ['name' => 'Bachelor of Commerce', 'code' => 'bcom', 'group' => 'bachelor', 'sort_order' => 60],
            ['name' => 'Bachelor of Science', 'code' => 'bsc', 'group' => 'bachelor', 'sort_order' => 70],
            ['name' => 'Bachelor of Engineering / Technology', 'code' => 'be_btech', 'group' => 'bachelor', 'sort_order' => 80],
            ['name' => 'Bachelor of Computer Applications', 'code' => 'bca', 'group' => 'bachelor', 'sort_order' => 90],
            ['name' => 'Bachelor of Business Administration / Management', 'code' => 'bba', 'group' => 'bachelor', 'sort_order' => 100],
            ['name' => 'Bachelor of Pharmacy', 'code' => 'bpharm', 'group' => 'bachelor', 'sort_order' => 110],
            ['name' => 'Bachelor of Laws', 'code' => 'llb', 'group' => 'bachelor', 'sort_order' => 120],
            ['name' => 'Bachelor of Medicine and Bachelor of Surgery', 'code' => 'mbbs', 'group' => 'bachelor', 'sort_order' => 130],
            ['name' => 'Bachelor of Dental Surgery', 'code' => 'bds', 'group' => 'bachelor', 'sort_order' => 140],
            ['name' => 'Bachelor of Science in Agriculture', 'code' => 'bsc_agri', 'group' => 'bachelor', 'sort_order' => 150],
            ['name' => 'Master of Arts', 'code' => 'ma', 'group' => 'master', 'sort_order' => 160],
            ['name' => 'Master of Commerce', 'code' => 'mcom', 'group' => 'master', 'sort_order' => 170],
            ['name' => 'Master of Science', 'code' => 'msc', 'group' => 'master', 'sort_order' => 180],
            ['name' => 'Master of Engineering / Technology', 'code' => 'me_mtech', 'group' => 'master', 'sort_order' => 190],
