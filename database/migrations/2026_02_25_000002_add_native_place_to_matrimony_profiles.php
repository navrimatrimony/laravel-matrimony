    ...
    public function up(): void
    {
        ...
        Schema::table('matrimony_profiles', function (Blueprint $table) {
            if (! Schema::hasColumn('matrimony_profiles', 'native_city_id')) {
                $table->foreignId('native_city_id')->nullable()->after('work_state_id')->constrained('addresses')->nullOnDelete();
            }
            if (! Schema::hasColumn('matrimony_profiles', 'native_taluka_id')) {
                $table->foreignId('native_taluka_id')->nullable()->after('native_city_id')->constrained('addresses')->nullOnDelete();
            }
            if (! Schema::hasColumn('matrimony_profiles', 'native_district_id')) {
                $table->foreignId('native_district_id')->nullable()->after('native_taluka_id')->constrained('addresses')->nullOnDelete();
            }
            if (! Schema::hasColumn('matrimony_profiles', 'native_state_id')) {
                $table->foreignId('native_state_id')->nullable()->after('native_district_id')->constrained('addresses')->nullOnDelete();
            }
        });
    }
