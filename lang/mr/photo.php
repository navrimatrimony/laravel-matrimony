...
/**
 * Photo upload page strings (Marathi).
 */
return [
    'profile_live_add_photo_more_responses' => '🎉 तुमची प्रोफाइल लाईव्ह आहे! अधिक प्रतिसादांसाठी फोटो जोडा.',
    'profile_details' => 'प्रोफाइल तपशील',
    'upload_photo' => 'फोटो अपलोड करा',
    'previous_photo_removed' => '⚠️ तुमचा मागील फोटो काढून टाकला आहे',
    'upload_your_photo' => 'तुमचा फोटो अपलोड करा',
    ...
    'preview' => 'पूर्वावलोकन',
    'adjust_crop_help_html' => 'क्रॉप समायोजित करा: <strong>चौकोनाचे कोपरे/कडा</strong> ओढून आकार बदला; <strong>चौकोनाच्या आत</strong> ओढून हलवा. नंतर <strong>Crop</strong> बटण वापरा.',
    'crop' => 'क्रॉप',
    'rotate_left' => 'डावीकडे फिरवा',
    'rotate_right' => 'उजवीकडे फिरवा',
    'change_photo' => 'फोटो बदला',
    'clear_face_jpg_png_max_2mb' => 'स्वच्छ चेहरा फोटो • JPG किंवा PNG • कमाल 2MB',
