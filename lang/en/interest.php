...
return [
    ...
    'interest_already_sent' => 'You have already sent interest to this profile.',
    'interest_not_found' => 'This interest was not found.',
    'profile_missing' => 'Profile not found. Refresh and try again.',
    'only_receiver_can_act' => 'Only the member who received this interest can do that.',
    'only_sender_can_withdraw' => 'Only the member who sent this interest can withdraw it.',
    'create_profile_action' => 'Start profile',
    'view_profile_action' => 'View profile',
    'blocked_list_action' => 'Blocked list',
