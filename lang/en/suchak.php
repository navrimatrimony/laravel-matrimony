    ...
    'status' => [
        ...
        'steps' => [
            ...
            'documents' => [
                ...
                'body' => 'Upload Aadhaar or identity proof, visiting card or office proof, and organization document when applicable. Documents can be submitted while other dashboard setup continues.',
                'submitted_body' => 'Documents are submitted correctly from your side. KYC stays pending until admin verifies the uploaded proof.',
            ],
            'kyc' => [
                'label' => 'KYC upload',
                'detail' => 'Identity and business proof.',
        ...
        'messages' => [
            ...
            'ready' => [
                ...
                'body' => 'Your WhatsApp OTP, admin review, and required KYC verification steps are complete.',
                'next' => 'Use the dashboard to continue allowed Suchak work.',
