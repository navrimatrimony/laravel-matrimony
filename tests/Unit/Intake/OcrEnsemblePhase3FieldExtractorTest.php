...
test('production name extractor reads English resume Name and biodata-title name lines', function () {
    ...
    expect($extractor->extract([
        ...
        ->and($extractor->extract([
            'मुलाचे नाव : विशाल पांडुरंग sree जन्म तारीख : ०२/११/१९९५',
            'कौटुंबिक माहिती',
            'चंडिलांचे नाव : चॉड्डरंग लक्ष्मण डाकवे (नोकरी-9322202146)',
        ]))->toBe('विशाल पांडुरंग डाकवे');
});
...
test('production name extractor recovers glued नाव and does not truncate चिवाजी', function () {
    ...
    expect($extractor->extract([
        ...
        ->and($extractor->extract([
            'नाव नवनाथ प्रकाश पाटील (कदम)',
            'जन्म तारीख December 10, 1995',
        ]))->toBe('नवनाथ प्रकाश पाटील (कदम)')
        ->and($extractor->extract([
            'मुलीचे नांव :-_ अॅड. स्नेहल शहाजी भोसले',
        ]))->toBe('स्नेहल शहाजी भोसले')
        ->and($extractor->extract([
            'मुलीचे नांव :- Adv. स्नेहल शहाजी भोसले',
        ]))->toBe('स्नेहल शहाजी भोसले')
        ->and($extractor->extract([
            'मुलाचे नाव - चि.अनिल जयवंत',
            'वडीलांचे नाव धि कै.जयवंत गणपती शिंदे',
        ]))->toBe('अनिल जयवंत शिंदे');
});
