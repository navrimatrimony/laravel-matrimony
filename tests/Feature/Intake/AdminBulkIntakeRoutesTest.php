...
test('admin bulk intake route names exist', function () {
    expect(route('admin.bulk-intakes.index'))->toBe(url('/admin/bulk-intakes'))
        ...
        ->and(route('admin.bulk-intakes.items.evidence-image', ['bulkIntakeBatch' => 123, 'bulkIntakeBatchItem' => 456]))->toBe(url('/admin/bulk-intakes/123/items/456/evidence-image'))
