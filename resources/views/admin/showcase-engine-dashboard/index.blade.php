...
<div class="space-y-6">
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
        ...
        <div class="flex flex-wrap gap-2 text-sm">
            <a href="{{ route('admin.showcase-photo-pool.index') }}" class="inline-flex items-center rounded-lg bg-emerald-50 dark:bg-emerald-900/30 px-3 py-1.5 font-medium text-emerald-800 dark:text-emerald-200 ring-1 ring-emerald-200 dark:ring-emerald-700 hover:bg-emerald-100 dark:hover:bg-emerald-900/50">Photo pool (eng/)</a>
            <a href="{{ route('admin.showcase-profile.bulk-create') }}" class="inline-flex items-center rounded-lg bg-violet-50 dark:bg-violet-900/30 px-3 py-1.5 font-medium text-violet-800 dark:text-violet-200 ring-1 ring-violet-200 dark:ring-violet-700 hover:bg-violet-100 dark:hover:bg-violet-900/50">Bulk create profiles</a>
