...
<div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6" x-data="{ adminEditMode: false }">
    ...
    <p class="text-sm text-gray-500 dark:text-gray-400 mb-2">{{ $matrimonyProfile->full_name ?? '—' }}@if ($matrimonyProfile->isShowcaseProfile()) <span class="inline-block ml-2 px-2 py-0.5 text-xs font-semibold bg-sky-100 dark:bg-sky-900/40 text-sky-700 dark:text-sky-300 rounded">Showcase</span>@endif</p>
    ...
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <div class="mb-6">
            <div class="flex justify-between items-center mb-1">
                ...
                <span class="text-sm font-bold text-gray-900">{{ $completion['detailed'] }}%</span>
            </div>
            <div class="w-full bg-gray-200 rounded-full h-2.5">
                <div class="bg-indigo-600 h-2.5 rounded-full transition-all duration-300" style="width: {{ $completion['detailed'] }}%;"></div>
            </div>
        </div>
        ...
        <div class="mb-6 flex flex-col items-center">
            ...
            @else
                ...
                <img
                    ...
                    class="w-40 h-40 rounded-full object-cover border"
                />
                @if ($matrimonyProfile->isShowcaseProfile())
