...
<div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
    ...
    <p class="text-gray-500 dark:text-gray-400 text-sm mb-6">Configure orchestration for showcase (is_demo) profiles. User UI shows only “AI Assisted Replies” tag.</p>
