    ...
    >
            ...
            <nav class="hidden p-4 flex-1 overflow-y-auto overscroll-contain space-y-2" aria-hidden="true" data-admin-legacy-sidebar x-data="{}" x-init="$nextTick(() => { const el = $el.querySelector('.nav-link.active'); if (el) el.scrollIntoView({ block: 'nearest', behavior: 'auto' }); })">
                    ...
                    <ul class="nav-group-items mt-0.5 ml-4 pl-3 border-l border-gray-700 space-y-0.5" x-show="open" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                        ...
                        <li>
                            <div class="nav-group" x-data="{ open: {{ $dataEngineOpen ? 'true' : 'false' }} }">
                                <button type="button" @click="open = !open" class="nav-group-btn w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-left text-gray-300">
                                    <svg class="w-4 h-4 shrink-0 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M9.75 3a2.25 2.25 0 012.25-2.25h6a2.25 2.25 0 012.25 2.25v12a2.25 2.25 0 01-2.25 2.25h-6a2.25 2.25 0 01-2.25-2.25V3zM6 6.75A2.25 2.25 0 018.25 4.5h3v15H8.25A2.25 2.25 0 016 17.25V6.75z" /></svg>
                                    <span>Data engine</span>
                                    <svg class="w-4 h-4 ml-auto nav-chevron shrink-0" :class="open && 'rotate-180'" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                                </button>
                                <ul class="nav-group-items mt-0.5 ml-4 pl-3 border-l border-gray-700 space-y-0.5" x-show="open" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                                    <li><a href="{{ route('admin.data-engine.index') }}" class="nav-link flex items-center gap-2 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.data-engine.index') ? 'active' : '' }}">Overview</a></li>
                                    <li><a href="{{ route('admin.data-engine.comparisons') }}" class="nav-link flex items-center gap-2 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.data-engine.comparisons') ? 'active' : '' }}">Comparisons</a></li>
                                    <li><a href="{{ route('admin.data-engine.issues') }}" class="nav-link flex items-center gap-2 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.data-engine.issues') ? 'active' : '' }}">Issue center</a></li>
                                    <li><a href="{{ route('admin.data-engine.workflows') }}" class="nav-link flex items-center gap-2 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.data-engine.workflows') ? 'active' : '' }}">Workflows</a></li>
                                    <li><a href="{{ route('admin.data-engine.rollback') }}" class="nav-link flex items-center gap-2 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.data-engine.rollback') ? 'active' : '' }}">Rollback center</a></li>
                                    <li><a href="{{ route('admin.data-engine.audit') }}" class="nav-link flex items-center gap-2 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.data-engine.audit') ? 'active' : '' }}">Audit trail</a></li>
                                    <li><a href="{{ route('admin.data-engine.system-health') }}" class="nav-link flex items-center gap-2 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.data-engine.system-health') ? 'active' : '' }}">System health</a></li>
                                    <li><a href="{{ route('admin.data-engine.data-lineage') }}" class="nav-link flex items-center gap-2 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.data-engine.data-lineage') ? 'active' : '' }}">Data lineage</a></li>
                                    <li><a href="{{ route('admin.data-engine.data-integrity') }}" class="nav-link flex items-center gap-2 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.data-engine.data-integrity') ? 'active' : '' }}">Data integrity</a></li>
                                    <li><a href="{{ route('admin.data-engine.marathi-columns') }}" class="nav-link flex items-center gap-2 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.data-engine.marathi-columns') || request()->routeIs('admin.data-engine.mr-fill.*') ? 'active' : '' }}">Reports</a></li>
                                    <li><a href="{{ route('admin.data-engine.profiles.show', ['profileId' => 207]) }}" class="nav-link flex items-center gap-2 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.data-engine.profiles.show') || request()->routeIs('admin.governance.profiles.*') ? 'active' : '' }}">Governance profile</a></li>
                                </ul>
                            </div>
                        </li>
                        @endif
                ...
                <div class="nav-group" x-data="{ open: true }">
                    ...
                    <ul class="nav-group-items mt-0.5 ml-4 pl-3 border-l border-gray-700 space-y-0.5" x-show="open" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                        ...
                        <li><span class="nav-link disabled flex items-center gap-3 px-3 py-2 rounded-lg text-sm" title="{{ __('admin.coming_soon') }}"><svg class="w-4 h-4 shrink-0 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" /></svg>{{ __('admin.suspended') }}</span></li>
                ...
                <div class="nav-group" x-data="{ open: {{ $masterDataOpen ? 'true' : 'false' }} }">
                    ...
                    <ul class="nav-group-items mt-0.5 ml-4 pl-3 border-l border-gray-700 space-y-0.5" x-show="open" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                        <li><a href="{{ route('admin.master.religions.index') }}" class="nav-link flex items-center gap-3 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.master.religions.*') ? 'active' : '' }}"><svg class="w-4 h-4 shrink-0 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582m15.686 0A11.953 11.953 0 0112 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0121 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0112 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 013 12c0-1.605.42-3.113 1.157-4.418" /></svg>Religions</a></li>
                        <li><a href="{{ route('admin.master.castes.index') }}" class="nav-link flex items-center gap-3 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.master.castes.*') ? 'active' : '' }}"><svg class="w-4 h-4 shrink-0 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM19.5 6v2.25a2.25 2.25 0 01-2.25 2.25H15a2.25 2.25 0 01-2.25-2.25V6M3.75 15.75h2.25A2.25 2.25 0 008.25 18v2.25a2.25 2.25 0 01-2.25 2.25H3.75a2.25 2.25 0 01-2.25-2.25V18a2.25 2.25 0 012.25-2.25z" /></svg>Castes</a></li>
                        <li><a href="{{ route('admin.master.sub-castes.index') }}" class="nav-link flex items-center gap-3 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.master.sub-castes.*') ? 'active' : '' }}"><svg class="w-4 h-4 shrink-0 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6z" /></svg>Sub-castes</a></li>
                        <li><a href="{{ route('admin.master.education.index') }}" class="nav-link flex items-center gap-3 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.master.education.index', 'admin.master.education-categories.*', 'admin.master.education-degrees.*') ? 'active' : '' }}"><svg class="w-4 h-4 shrink-0 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6.75L3 10.5l9 3.75 9-3.75-9-3.75z" /><path stroke-linecap="round" stroke-linejoin="round" d="M6.75 12.75v3.375c0 .621.504 1.125 1.125 1.125h8.25c.621 0 1.125-.504 1.125-1.125V12.75" /></svg>Education</a></li>
                ...
                <div class="nav-group" x-data="{ open: {{ $matchingEngineOpen ? 'true' : 'false' }} }">
                    <button type="button" @click="open = !open" class="nav-group-btn w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-left text-gray-300">
                        ...
                        <span>{{ __('matching_engine.nav_group') }}</span>
                        <svg class="w-4 h-4 ml-auto nav-chevron shrink-0" :class="open && 'rotate-180'" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                    </button>
                    <ul class="nav-group-items mt-0.5 ml-4 pl-3 border-l border-gray-700 space-y-0.5" x-show="open" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                        <li><a href="{{ route('admin.matching-engine.overview') }}" class="nav-link flex items-center gap-3 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.matching-engine.overview') ? 'active' : '' }}"><svg class="w-4 h-4 shrink-0 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3" /></svg>{{ __('matching_engine.nav_overview') }}</a></li>
                        <li><a href="{{ route('admin.matching-engine.fields') }}" class="nav-link flex items-center gap-3 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.matching-engine.fields*') ? 'active' : '' }}"><svg class="w-4 h-4 shrink-0 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 7.5h15M4.5 12h15m-15 4.5h15" /></svg>{{ __('matching_engine.nav_fields') }}</a></li>
                        <li><a href="{{ route('admin.matching-engine.filters') }}" class="nav-link flex items-center gap-3 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.matching-engine.filters*') ? 'active' : '' }}"><svg class="w-4 h-4 shrink-0 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 3c2.755 0 5.455.232 8.083.678a.75.75 0 01.58.875l-.974 4.57a.75.75 0 01-.465.63 4.5 4.5 0 00-2.52 4.065v.345a48.63 48.63 0 01-8.25 0v-.345a4.5 4.5 0 00-2.52-4.065.75.75 0 01-.465-.63l-.974-4.57a.75.75 0 01.58-.875A49.05 49.05 0 0112 3z" /></svg>{{ __('matching_engine.nav_filters') }}</a></li>
                        <li><a href="{{ route('admin.matching-engine.behavior') }}" class="nav-link flex items-center gap-3 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.matching-engine.behavior*') ? 'active' : '' }}"><svg class="w-4 h-4 shrink-0 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M15.042 21.672L13.684 16.6m0 0l-2.51 2.225.569-9.47 5.227 7.917-3.286-.672zM12 2.25V4.5m5.834.166l-1.591 1.591M20.25 10.5H18M7.757 14.743l-1.59 1.59M6 10.5H3.75m4.634-3.893l-1.591-1.591" /></svg>{{ __('matching_engine.nav_behavior') }}</a></li>
                        <li><a href="{{ route('admin.matching-engine.boosts') }}" class="nav-link flex items-center gap-3 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.matching-engine.boosts*') ? 'active' : '' }}"><svg class="w-4 h-4 shrink-0 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" /></svg>{{ __('matching_engine.nav_boosts') }}</a></li>
                        <li><a href="{{ route('admin.matching-engine.ai') }}" class="nav-link flex items-center gap-3 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.matching-engine.ai') ? 'active' : '' }}"><svg class="w-4 h-4 shrink-0 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z" /></svg>{{ __('matching_engine.nav_ai') }}</a></li>
                        <li><a href="{{ route('admin.matching-engine.preview') }}" class="nav-link flex items-center gap-3 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.matching-engine.preview') ? 'active' : '' }}"><svg class="w-4 h-4 shrink-0 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" /><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /></svg>{{ __('matching_engine.nav_preview') }}</a></li>
                ...
                <div class="nav-group" x-data="{ open: {{ $settingsOpen ? 'true' : 'false' }} }">
                    ...
                    <ul class="nav-group-items mt-0.5 ml-4 pl-3 border-l border-gray-700 space-y-0.5" x-show="open" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                        ...
                        @endif
                        @if ($canManageSeriousIntents)
                            <li><a href="{{ route('admin.serious-intents.index') }}" class="nav-link flex items-center gap-3 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.serious-intents.*') ? 'active' : '' }}"><svg class="w-4 h-4 shrink-0 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m6-6H6" /></svg>Serious Intents</a></li>
                        @endif
        ...
        <main class="flex-1 min-h-screen min-w-0 text-gray-900 lg:ml-64">
            ...
            <div class="{{ $adminContentWrapperClass ?? (($showcaseOpen ?? false) ? 'max-w-[1680px] w-full mx-auto px-4 sm:px-6 lg:px-8' : 'w-full max-w-none px-4 sm:px-6 lg:px-8') }} py-6">
                ...
                @endif
                @php
                    $modAlertUnsafe = false;
                    $modAlertUnsafeCount = 0;
                    if (\Illuminate\Support\Facades\Schema::hasTable('profile_photos') && \Illuminate\Support\Facades\Schema::hasColumn('profile_photos', 'moderation_scan_json')) {
                        $modAlertSvc = app(\App\Services\Admin\ModerationAlertService::class);
                        $modAlertUnsafe = $modAlertSvc->shouldShowUnsafeBurstAdminBanner();
                        $modAlertUnsafeCount = $modAlertSvc->unsafeUploadBurstLastHourCount();
                    }
                @endphp
                @if ($modAlertUnsafe)
                    <div class="mb-4 rounded-lg border border-rose-300 bg-rose-50 px-4 py-3 text-sm text-rose-900 dark:border-rose-700 dark:bg-rose-950/40 dark:text-rose-100" role="alert">
                        <strong>Moderation alert:</strong> more than 10 photos classified <strong>unsafe</strong> in the last hour
