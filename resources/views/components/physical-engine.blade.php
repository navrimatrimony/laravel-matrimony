...
<div class="physical-engine space-y-6 border-2 border-rose-500 dark:border-rose-400 rounded-lg p-4">
    ...
    <div>
        <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Core Physical Details</h3>
    ...
    <div>
        <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Additional Physical Details</h3>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Spectacles / Lens</label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Physical Condition</label>
