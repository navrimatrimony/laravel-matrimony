    ...
    <div class="flex items-center gap-1.5 flex-nowrap contact-master-field">
        @if($showCountryCode)
            <input type="text"
                   ...
                   class="text-xs text-gray-600 dark:text-gray-400 border border-gray-300 dark:border-gray-600 rounded py-1.5 bg-gray-50 dark:bg-gray-700 h-9 box-border text-center contact-cc-input"
