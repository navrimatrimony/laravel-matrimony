...
<div class="religion-caste-component grid md:grid-cols-3 gap-2 border-2 border-rose-500 dark:border-rose-400 rounded-lg p-4">
    <div class="religion-wrap">
        ...
        <div class="relative">
            ...
            <input type="text" class="religion-input w-full rounded border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 px-3 py-2.5 h-[42px]" autocomplete="off" placeholder="{{ __('Type to search religion') }}"
    ...
    <div class="caste-wrap">
        ...
        <div class="relative">
            ...
            <input type="text" class="caste-input w-full rounded border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 px-3 py-2.5 h-[42px]" autocomplete="off" placeholder="{{ __('Select religion first, then type to search') }}"
    ...
    <div class="subcaste-wrap">
        ...
        <div class="relative">
            ...
            <input type="text" class="subcaste-input w-full rounded border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 px-3 py-2.5 h-[42px]" autocomplete="off" placeholder="{{ __('Type to search or add new') }}"
