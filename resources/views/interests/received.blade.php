...
<div class="py-10">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-8">
            <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100">{{ __('interests.received_interests') }}</h1>
        ...
        @empty
            <p class="text-center text-gray-600 dark:text-gray-400">{{ __('interests.no_received_interests') }}</p>
        @endforelse
    </div>
</div>
@endsection
