...
<div class="border border-gray-200 dark:border-gray-600 p-4 rounded-lg bg-gray-50 dark:bg-gray-700/30 space-y-4">
    <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-300">Widowed — marriage details</h3>
    <div>
    ...
    <div>
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Spouse Death Year</label>
        <input type="number" name="marriages[0][spouse_death_year]" min="1901" max="2155"
