...
<div class="space-y-8">
    ...
    <div class="space-y-3">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400">Add one row per person. Use "Add" to add more rows — e.g. 4 uncles = 4 rows, each with Relation "Paternal Uncle (chulte)". Native village/town is captured under Location (native place), not here. For all other relatives (आडनाव/गाव) use the "Other Relatives" section in the Relatives tab.</p>
