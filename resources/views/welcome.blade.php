            ...
            <div class="max-w-5xl mx-auto">
                ...
                <div class="flex items-center justify-center w-full">
                    ...
                    <form method="GET" action="{{ route('matrimony.profiles.index') }}" class="space-y-4">
                        ...
                        {{-- Location Field (centralized typeahead — submits city_id for search) --}}
                        <div class="welcome-search-location">
                            @php
                                $searchCityId = old('city_id', request()->get('city_id', ''));
                                $searchLocationDisplay = $searchCityId ? (\App\Models\City::find($searchCityId)?->name ?? '') : (old('location', request()->get('location', '')));
                            @endphp
                            <x-profile.location-typeahead
                                ...
                                :data-state-id="old('state_id', request()->get('state_id', ''))"
                                :data-district-id="old('district_id', request()->get('district_id', ''))"
                                :data-taluka-id="old('taluka_id', request()->get('taluka_id', ''))"
                                :data-country-id="old('country_id', request()->get('country_id', ''))"
                            />
                        </div>
                ...
                <div class="bg-[#eee] dark:bg-[#222] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden flex items-center justify-center">
                    ...
                    <div class="hidden w-full h-full flex items-center justify-center text-[#706f6c] dark:text-[#A1A09A] text-sm">
                        <p>Matrimonial Image</p>
                    </div>
