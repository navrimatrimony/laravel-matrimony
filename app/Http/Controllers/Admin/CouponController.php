...
/**
 * Monetization admin UI for coupons (same persistence as {@see AdminCouponController}; separate routes/views only).
 */
class CouponController extends Controller
{
    ...
    public function toggleActive(Coupon $coupon)
    {
        ...
        return redirect()
            ->route('admin.coupons.index')
            ->with('success', __('admin_monetization.coupon_toggle_saved'));
    }
