...
class CommunicationPolicyController extends Controller
{
    ...
    public function update(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'suchak_max_consecutive_messages_without_reply' => 'required|integer|min:1|max:20',
            'suchak_reply_gate_cooling_hours' => 'required|integer|min:1|max:720',
        ...
        $updates = [
            ...
            'suchak_max_consecutive_messages_without_reply' => (string) $request->input('suchak_max_consecutive_messages_without_reply'),
            'suchak_reply_gate_cooling_hours' => (string) $request->input('suchak_reply_gate_cooling_hours'),
