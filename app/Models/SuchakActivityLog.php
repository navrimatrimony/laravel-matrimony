...
class SuchakActivityLog extends Model
{
    ...
    public const ACTION_CONSENT_REJECTED = 'consent_rejected';

    public const ACTION_CONSENT_EXPIRED = 'consent_expired';
    ...
    public const ACTION_PAYMENT_REQUEST_PAID_REVERSED = 'payment_request_paid_reversed';
