...
/**
 * Suchak-facing: a represented customer requested account deletion (day 0).
 *
 ...
 */
class SuchakCustomerDeletionRequestedNotification extends Notification
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        return NotificationMarathiPayload::withMessage([
            'type' => 'suchak_customer_deletion_requested',
            'message_key' => 'account.suchak_customer_deletion_requested',
            'message_params' => [
