...
final class HtmlMarathiBiodataTableExtractor
{
    ...
    private static function mapLabelToSlot(string $label, string $value): ?string
    {
        ...
        $rows = [
            ...
            ['birth_time', '/^(?:जन्मवेळ|जन्म\s*वेळ|जन्म\s*वेल|जन्म\s*वार\s*व\s*वेळ|जन्मवार\s*व\s*वेळ)$/u'],
            ...
            ['other_relatives_text', '/^(?:इतर\s*नातेवाईक|इतर\s*पाहुणे|नातेसंबंध|नाते\s*संबंध)$/u'],
